...
syn keyword pythonConditional	if elif else and in is not or
syn keyword pythonPreCondit	import
syn keyword pythonPreProc       from as
...
"syn match pythonFunction        "\ [a-zA-Z-][a-z0-9-]*("
"syn match pythonFunction        "\.[a-zA-Z-][a-z0-9-]*("
" Delimiters
...
" Constant
syn match pythonConstant "[A-Z][A-Z-][A-Z]*-*" 
...
if version >= 508 || !exists("did_python_syn_inits")
  ...
  HiLink pythonCompare          Compare

  HiLink pythonDelimiter        Delimiter

  HiLink pythonSpecialChar      SpecialChar
